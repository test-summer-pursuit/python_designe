...
if __name__=='__main__':
    ...
    # 调用获取HTML的方法
    html = pre_cityid_csv.get_html1(url)
    file_path = 'C:/Users/29753/PycharmProjects/pythonProject/python_design/中国天气网城市信息.csv'
    # 判断存放城市信息的数据文件是否存在。如果不存在，则调用get_cityinfo_write方法下载
    if not os.path.exists(file_path):
        pre_cityid_csv.get_cityinfo_write1(html)
    # 读取城市信息
    ...
    if name in city_name:
        ...
        # 解析出时间
        url3 = 'http://www.weather.com.cn/weather/'+str(city_url[city_name.index(name)])+'.shtml'  # 7天天气中国天气网
        url2 = 'http://www.weather.com.cn/weather15d/'+str(city_url[city_name.index(name)])+'.shtml'  # 8-15天天气中国天气网

        html1 = getHTMLtext(url3)
